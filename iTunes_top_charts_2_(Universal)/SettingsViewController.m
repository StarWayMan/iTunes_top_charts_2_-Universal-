...
- (void)viewDidLoad {
    ...
    mediaTypesObjects = [[NSArray alloc] initWithObjects:@"topaudiobooks", @"topfreeebooks", @"toppaidebooks", @"toptextbooks", @"newapplications", @"newfreeapplications", @"newpaidapplications", @"topfreeapplications", @"topfreeipadapplications", @"topgrossingapplications", @"topgrossingipadapplications", @"toppaidapplications", @"toppaidipadapplications", @"topitunesucollections", @"topitunesucourses", @"topfreemacapps", @"topgrossingmacapps", @"topmacapps", @"toppaidmacapps", @"topmovies", @"topvideorentals", @"topalbums", @"topimixes", @"topsongs", @"topmusicvideos", @"toppodcasts", @"toptvepisodes", @"toptvseasons", nil];
